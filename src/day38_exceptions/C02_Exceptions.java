    ...
    public static void main(String[] args) {
        ...
        try blogu yapmaya calistigimiz ama risk oldugunu dusundugumuz
                  ...
                  turunu Javaya soylemek icin kullanilir
                   ...
                   catch blogunun onundeki karsilasmayi bekledigimiz exception i yazabilir
                   veya her turlu exception da devreye girmesini istiyorsak
                   tum excetion larin parent i olan Exception yazabiliriz.
         */
            try {
                System.out.println(a/b);
            } catch (Exception e) {// e bir variable ismi oraya deneme de yazsak calisir
