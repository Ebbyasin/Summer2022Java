...
public class C03_Contains {
    public static void main(String[] args) {
        ...
        boolean sonuc= contains(isimler,arananIsim); // BUNU YAZDİGİMİZ İCİN YENİ METHOD OLUSURKEN VOİD YAZMIYOR
                                                     // VE ASAGİDA RETURN İSTİYOR.
        if (sonuc){   //burda true yada false demeden nasil yazdirdik,asagida sonucMethod=true yazincada sonuc degismiyor
