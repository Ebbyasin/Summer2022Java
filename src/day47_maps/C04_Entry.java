...
public class C04_Entry {
    ...
    public static void main(String[] args) {
        ...
        /*
        Java Entry<K,V> map'in icerisinde bulunan her bir kaydi K=V
        seklinde tutar
        dolayisiyle herhangi bir Entry'e ulastigimizda
        ...
        //Map'in tum elemanlarinda Tester kurs ismini QA olarak degistirelim
