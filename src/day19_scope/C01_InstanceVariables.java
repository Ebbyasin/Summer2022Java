...
public class C01_InstanceVariables {
        ...
        /*
        class icerisinde heryerden  kullanmak istediğiniz variable lari
        class level da (Class in icinde ama methodun  disinda)
        genellikle class level variable lar  class in basinda olusturulur,(sart mıdır degildir.)
        class isminin altina yazilir.
        ...
        instance variables static olmadigi icin static kulube uye main method dan direk kullanamayis
        intstance variable larin diger adi object variable dir.
        dolayisiyla obje olusturursaniz instance variable lari heryerden kullanabilirsiniz
         */

        /*
        instance variablles static olmadigi icin  static
         */
            C01_InstanceVariables obje1=new C01_InstanceVariables();
            System.out.println("obje1 degismeden once : "+obje1.instSayi); //20
            obje1.instSayi=30; //30
            ...
            /*
            her obje olustugunda instance yani obje variable inin ilk atanan degerini alir
             */
    ...
    public static void staticMethod(){
       ...
       // System.out.println(sayi);
        ...
        sadeceo method un  icinden  kullanilabilir
        (local variables)
         */
       /*
        instSayi=30;
        instance variable lara main method disindaki static methodlardanda
        direk olusamayiz,obje olusturursak ulasabiliriz
        */
