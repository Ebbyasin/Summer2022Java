...
public class C03_Date {
    ...
    public static void main(String[] args) {
        ...
        LocalDate tarih2= LocalDate.of(1982,9,26);
        System.out.println(tarih2);// 1982-09-26

        LocalDate tarih3=LocalDate.of(1990, Month.JANUARY,10);// 1990-01-10
        ...
        hangisinde doganin  daha buyuk oldugunu bulunuz(if else le yapmaya calissak 20-30 dakika zaman alir)
         */
        //tarih2 ile takih3 icin yapalim?
