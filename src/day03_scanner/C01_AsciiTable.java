...
public class C01_AsciiTable {
    public static void main(String[] args) {
        ...
        char yeniHarf =harf+2  java once sagdaki islemi yapar,sagda int + char gorunce asccii degerini alir ve sonucu 99
         ...
         2-(str+harf); // banana string variable cok gucludur,hangi data turu yle isleme girerse girsin
                          diger data turunu kendine benzetir.


           */
        //peki... konsolda verilen variable leri kullanarak 10a gormek istersek nasil yazdirmaliyiz?

        System.out.println(""+sayi+harf);

        char deger='1';
        System.out.println(deger+harf); // '1' + 'a' --->146
        char ifade='z';
        System.out.println(deger+ifade);
