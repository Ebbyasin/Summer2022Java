...
public class C02_PassByValue {
    ...
    public static double indirimliFiyat(double orjinalFiyat){
        //methodumuz %10 indirim yapip yeni fiyati
        // main method a dondursun
        ...
        biz programı calıstırırken sürekli scope lar arasında hareket ederiz, neden cunku main methodlar bizim robotlarımızdı
