...
public class C08_WhileLoop {
    ...
    public static void main(String[] args) {
        ...
        while(toplam<500 ){
            System.out.println("Lutfen toplamak icin sayi girin"); //kullanicidan sayiyi nasil alirim,kullaniciya mesaj
            sayi=scan.nextInt();// sonra kullanicinin girdigi o sayiyi alacak
            toplam+=sayi;
            sayac++;
        }
