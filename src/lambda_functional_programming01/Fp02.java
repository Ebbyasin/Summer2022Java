...
import static lambda_functional_programming01.Fp01.listElemanlariniYazdirFunctional;
...
public class Fp02 {
    ...
    */
    ...
    //2. Yol
    public static void tekrarsizCiftElemanlarinKareToplami02(List<Integer> list){//burda isim degisikligi yapildi.
    // tekrarsizCiftElemanlarinKareToplami02 oldu.uzerine gelip sag tik refactor rename yaparsak,sayfadaki diger ayni
    // isimlerde otomatik olarak degisir.
    ...
    public static void terSiralamaylaTekrarsizElemanlarinYarisi(List<Integer> list){
        ...
        //github da bir siknti olustu sanirim
