...
public class Fp01 {
    ...
    public static void getMaxEleman02(List<Integer> list){
        ...
        Integer max = list.stream().distinct().sorted().reduce(Integer.MIN_VALUE, (t,u)->u);//burda sorted yapip
        // naturel ordering(dogal siralama)yapiyoruz,yani kucukten buyuge..sonra reducela sunu diyoruz:t ile u dan hep
        // ikinci olani yani u'yu al..
    ...
    public static void getTersSiralamaylaTekrarsizElemanlarinYarisi(List<Integer> list){
      ...
      //burda map in ici "t/2.0".. neden 2.0;cunku 2 ye bolseydik iki integer bolumu integer olurdu.yani 5/2=2.5 ama
        // java bunu 2 alirdi,bir integer olarak..List i double yapmaya gerek yok,burda 5 i 2.0 a bolerse double integer
        // dan daha genis oldugu icin sonuc double olur.yani bolumu 2.0 alirsak -ki bu double deger- 5/2 sonucu da 2.5
        // yani double olur.
