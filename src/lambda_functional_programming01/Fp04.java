...
public class Fp04 {
    public static void main(String[] args) {
        ...
        System.out.println(factoriyelHesapla(4));
    ...
    //7'den 100'e kadar integer degerlerinin toplamini bulan bir method olusturun.
    ...
    public static int factoriyelHesapla(int x){
