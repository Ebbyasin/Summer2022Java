...
public class C01_Lists {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sayilar1.set(1,2));
        /*
         set method'u istenen index'deki eski elementi silip,
          ...
          set() sildigi eski elementi bize dondurur;sout la yazarsak direk cikardigi sayiyi yazar
          ,once eskiyi silip,yerine yeniyi koyar
          , listeden cıkardigi sayiyi yazar,getirir
